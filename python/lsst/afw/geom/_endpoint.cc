...
void declareBaseEndpoint(lsst::utils::python::WrapperCollection &wrappers, std::string const &suffix) {
    ...
    wrappers.wrapType(py::class_<Class>(wrappers.module, pyClassName.c_str()),
                      [](auto &mod, auto &cls) {
...
void declareBaseVectorEndpoint(lsst::utils::python::WrapperCollection &wrappers, std::string const &suffix) {
    ...
    wrappers.wrapType(py::class_<Class, BaseEndpoint<Point, Array>>(
...
void declarePoint2Endpoint(lsst::utils::python::WrapperCollection &wrappers) {
    ...
    wrappers.wrapType(py::class_<Class, BaseVectorEndpoint<Point>>(
                              wrappers.module, pyClassName.c_str()),
                      [](auto &mod, auto &cls) {
                          cls.def(py::init<>());
