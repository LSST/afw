...
void declareCovariograms(lsst::utils::python::WrapperCollection &wrappers, const std::string &suffix) {
    ...
    wrappers.wrapType(py::class_<Covariogram<T>>(
    ...
    wrappers.wrapType(
            py::class_<SquaredExpCovariogram<T>, Covariogram<T>>(
    ...
    wrappers.wrapType(
            py::class_<NeuralNetCovariogram<T>, Covariogram<T>>(
...
void declareGaussianProcess(lsst::utils::python::WrapperCollection &wrappers, const std::string &suffix) {
    wrappers.wrapType(
            ...
            [](auto &mod, auto &cls) {
                /* Constructors */
                cls.def(py::init<ndarray::Array<T, 2, 2> const &, ndarray::Array<T, 1, 1> const &,
                                 std::shared_ptr<Covariogram<T>> const &>());
                cls.def(py::init<ndarray::Array<T, 2, 2> const &, ndarray::Array<T, 1, 1> const &,
                                 ndarray::Array<T, 1, 1> const &, ndarray::Array<T, 1, 1> const &,
                                 std::shared_ptr<Covariogram<T>> const &>());
                cls.def(py::init<ndarray::Array<T, 2, 2> const &, ndarray::Array<T, 2, 2> const &,
                                 std::shared_ptr<Covariogram<T>> const &>());
                cls.def(py::init<ndarray::Array<T, 2, 2> const &, ndarray::Array<T, 1, 1> const &,
